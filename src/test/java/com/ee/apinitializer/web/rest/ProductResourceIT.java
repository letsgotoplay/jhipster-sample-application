package com.ee.apinitializer.web.rest;
...
import com.ee.apinitializer.IntegrationTest;
...
class ProductResourceIT {
    ...
    private static final Instant DEFAULT_LIVE_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_LIVE_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    void createProduct() throws Exception {
        ...
        assertThat(testProduct.getLiveDate()).isEqualTo(DEFAULT_LIVE_DATE);
    }
    ...
    void getAllProducts() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.[*].liveDate").value(hasItem(DEFAULT_LIVE_DATE.toString())));
    }
    ...
    void getProduct() throws Exception {
        ...
        restProductMockMvc
            ...
            .andExpect(jsonPath("$.liveDate").value(DEFAULT_LIVE_DATE.toString()));
    }
    ...
    void putExistingProduct() throws Exception {
        ...
        assertThat(testProduct.getLiveDate()).isEqualTo(UPDATED_LIVE_DATE);
    }
    ...
    void partialUpdateProductWithPatch() throws Exception {
        ...
        partialUpdatedProduct.liveDate(UPDATED_LIVE_DATE);
