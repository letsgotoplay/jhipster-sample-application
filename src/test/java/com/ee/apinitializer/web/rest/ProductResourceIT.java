...
class ProductResourceIT {
    ...
    @Test
    @Transactional
    void getAllProductsByVersionIsGreaterThanOrEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where version is greater than or equal to DEFAULT_VERSION
        defaultProductShouldBeFound("version.greaterThanOrEqual=" + DEFAULT_VERSION);

        // Get all the productList where version is greater than or equal to UPDATED_VERSION
        defaultProductShouldNotBeFound("version.greaterThanOrEqual=" + UPDATED_VERSION);
    }

    @Test
    @Transactional
    void getAllProductsByVersionIsLessThanOrEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where version is less than or equal to DEFAULT_VERSION
        defaultProductShouldBeFound("version.lessThanOrEqual=" + DEFAULT_VERSION);

        // Get all the productList where version is less than or equal to SMALLER_VERSION
        defaultProductShouldNotBeFound("version.lessThanOrEqual=" + SMALLER_VERSION);
    }

    @Test
    @Transactional
    void getAllProductsByVersionIsLessThanSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where version is less than DEFAULT_VERSION
        defaultProductShouldNotBeFound("version.lessThan=" + DEFAULT_VERSION);

        // Get all the productList where version is less than UPDATED_VERSION
        defaultProductShouldBeFound("version.lessThan=" + UPDATED_VERSION);
    }

    @Test
    @Transactional
    void getAllProductsByVersionIsGreaterThanSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where version is greater than DEFAULT_VERSION
        defaultProductShouldNotBeFound("version.greaterThan=" + DEFAULT_VERSION);

        // Get all the productList where version is greater than SMALLER_VERSION
        defaultProductShouldBeFound("version.greaterThan=" + SMALLER_VERSION);
    }
    ...
    @Test
    @Transactional
    void getAllProductsByLiveDateIsEqualToSomething() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where liveDate equals to DEFAULT_LIVE_DATE
        defaultProductShouldBeFound("liveDate.equals=" + DEFAULT_LIVE_DATE);

        // Get all the productList where liveDate equals to UPDATED_LIVE_DATE
        defaultProductShouldNotBeFound("liveDate.equals=" + UPDATED_LIVE_DATE);
    }

    @Test
    @Transactional
    void getAllProductsByLiveDateIsInShouldWork() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where liveDate in DEFAULT_LIVE_DATE or UPDATED_LIVE_DATE
        defaultProductShouldBeFound("liveDate.in=" + DEFAULT_LIVE_DATE + "," + UPDATED_LIVE_DATE);

        // Get all the productList where liveDate equals to UPDATED_LIVE_DATE
        defaultProductShouldNotBeFound("liveDate.in=" + UPDATED_LIVE_DATE);
    }

    @Test
    @Transactional
    void getAllProductsByLiveDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        productRepository.saveAndFlush(product);

        // Get all the productList where liveDate is not null
        defaultProductShouldBeFound("liveDate.specified=true");

        // Get all the productList where liveDate is null
        defaultProductShouldNotBeFound("liveDate.specified=false");
    }
